...
RSpec.describe "ReportUploaders", type: :system do
  ...
  def get_single_record
    FileParser::JSONRecordParser.call( Rails.root.join( 'spec', 'fixtures', 'request_bodies', 'json_files', 'single_record_upload.json' ) )
  end

  def get_multiple_records
    FileParser::JSONRecordParser.call( Rails.root.join( 'spec', 'fixtures', 'request_bodies', 'json_files', 'multi_record_upload.json' ) )
  end
